...
proxy2:
	CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o ./build/mosn -ldflags "-X mosn.io/mosn/pkg/types.IstioVersion=1.6.5" ./cmd/mosn/main
	docker build -t registry.cn-hangzhou.aliyuncs.com/champly/proxyv2:1.6.5 -f ./build/Dockerfile .